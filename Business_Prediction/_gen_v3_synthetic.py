...
astro_html = render_astrologer_report_html("Synthetic Audit Chart v3", prediction, payload=payload, lang="en")
client_html = render_client_report_html("Synthetic Audit Chart v3", prediction, payload=payload, lang="en")

out_dir = _repo / "Business_Prediction" / "outputs"
(out_dir / "audit_synthetic_astrologer_v3.html").write_text(astro_html, encoding="utf-8")
(out_dir / "audit_synthetic_client_v3.html").write_text(client_html, encoding="utf-8")
print("wrote v3 reports")
