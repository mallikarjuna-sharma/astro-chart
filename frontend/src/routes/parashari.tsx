...
function ParashariPage() {
  ...
  return (
    <div>
      <PageHeader title="Parashari Strength Analysis" subtitle="Quantitative strength from /api/shadbala and /api/ashtakavarga." />
      <Tabs defaultValue="shadbala">
        ...
        <TabsContent value="shadbala" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Shadbala (planetary strength)</CardTitle>
              <CardDescription>
                    ...
                    {shadbala.rows.map((r) => {
                      ...
                      return (
                        <tr key={r.planet} className="border-t border-border">
                          <td className={`py-1.5 ${strong ? "text-green-600 font-bold" : weak ? "text-destructive font-bold" : "text-gold"}`}>
                            {r.planet}
                          </td>
        ...
        <TabsContent value="ashtaka" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>Ashtakavarga (SAV + BAV)</CardTitle>
              <CardDescription>Sarvashtakavarga total: {ashtaka?.sav_total ?? "—"}</CardDescription>
            </CardHeader>
