...
Ayanamsa: Lahiri (23.85° base at J2000 + 0.013968°/year precession).
...
def compute_stakeholder_radar(
    ...
    if h6_afflicted:
        ...
        advice_parts.append(
            f"⚠ H6 afflicted by {planets_str}: High probability of team friction or "
            f"subordinate attrition. Practise defensive communication — avoid confrontational "
